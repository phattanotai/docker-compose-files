...
<head>
    ...
    <title>ทดสอบ</title>
    <link rel="stylesheet"
        href="https://fonts.googleapis.com/css?family=Kanit:300,400,600,700,800%7CPoppins:300,400,500,600,700%7CSegoe+Script:300,400,500,600,700"
        media="all">
                    ...
                    <div class="card border-0 shadow p-3">
                        <div class="card-body">
                            ...
                            <div class="card-title text-center mb-5 p-2">
                                ...
                                <center><img class="phone-fix vert-move" src="/img/promptpay-update-stats-2018-p01.jpg">
                                </center>
                                <?php
                                $amount = 10;
                                $amount = $_GET['amount'];
                            ...
                            <form method="get" action="./checkout/">
                                <div class="form-group mb-4">
                                    <div class="input-group mb-4">
                                        <span class="input-group-text" id="basic-addon1" style="background:#fff;"><svg
                                        ...
                                        <input type="number" id="amount" name="amount" class="form-control"
                                            ...
                                            value="<?php echo $amount; ?> <?php if (empty($amount)) {
                                                                                                                                                                                echo 'value=10';
                                                                                                                                                                            } elseif ($amount == 'undefined') {
                                                                                                                                                                                echo 'value=10';
                                                                                                                                                                            } else {
                                                                                                                                                                            } ?>"
                                            <?php if (empty($amount)) {
                                    ...
                                    <div class="input-group mb-4">
                                        ...
                                        <input type="text" id="href" name="href" class="form-control"
                                            placeholder="เลขอ้างอิง(ไม่จำเป็นต้องใส่)" value="<?php echo $href; ?>"
                                            <?php if (empty($href)) {
                                                                                                                                                                                } else {
                                                                                                                                                                                    echo "disabled";
                                                                                                                                                                                } ?>>
                            ...
                            <a href="/Payment" class="btn green-btn col-12 p-2">กลับไปหน้าหลัก</a>
                        </div>
                    </div>
                </div>
            </div>
